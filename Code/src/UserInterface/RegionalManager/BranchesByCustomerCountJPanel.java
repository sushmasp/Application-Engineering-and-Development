 ...
 * @author kurki
 */
public class BranchesByCustomerCountJPanel extends javax.swing.JPanel {
    
    private JPanel userProcessContainer;
    private Region region;
   
    public BranchesByCustomerCountJPanel(JPanel userProcessContainer,Region region) {
        initComponents();
     ...
     private void populatetable()
    {
        ...
        {
           Collections.sort(region.getBranchDirectory().getBranchList());
           for(Branch b: region.getBranchDirectory().getBranchList())
              {
                 Object[] row = new Object[2];
                 row[0]= b.getBranchName();
                 row[1] =b.getCustomerCount();
                 dtm.addRow(row);  
               }
        }
    ...
    private void initComponents() {
        ...
        tblBranches.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Branch Name", "Number Of Customers"
            }
        ) {
        ...
        jLabel1.setText("Branches By Customer Count");
    ...
    private void btnGraphicalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraphicalViewActionPerformed
        ...
        if(!(region.getBranchDirectory().getBranchList().isEmpty()))
        {
            for (Branch b : region.getBranchDirectory().getBranchList())
            {
                dataset.setValue(b.getCustomerCount(), "Customer Count", b.getBranchName());
            }
        }
        JFreeChart chart = ChartFactory.createBarChart("Customer Count Graph", "Branch", "Customer Count", dataset,PlotOrientation.VERTICAL,false,true,false);
