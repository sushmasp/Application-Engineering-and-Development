...
import Business.Role.BranchManagerRole;
 ...
 * @author kurki
 */
public class NewBranchManagerJPanel extends javax.swing.JPanel {
    ...
    public NewBranchManagerJPanel(JPanel userProcessContainer,Region region,String branchName,Business business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" New Branch Manager");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(25, 25, 25)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtPhoneNumber, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
	...
	if(matcher.matches()==false)
        ...
        // Creating branch from previous page
        Branch branch = region.getBranchDirectory().createBranch(branchName, Branch.BranchType.BofA);
        

        Employee e = branch.getEmployeeDirectory().addEmployee();
        ...
        // Creating UserAccount
         ...
         branch.getUserAccountDirectory().createUserAccount(txtUsername.getText().trim(), password,e,new BranchManagerRole());
        
        

        JOptionPane.showMessageDialog(null, "New Branch Manager assigned to the newly created Branch: " + branch.getBranchName()+ " successfully.","INFORMATION",JOptionPane.INFORMATION_MESSAGE);
