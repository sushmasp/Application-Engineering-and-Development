...
import UserInterface.BranchManager.BranchManagerWorkAreaJPanel;
...
public class BranchManagerRole extends Role{
    ...
    {
        this.roleType = Role.RoleType.BranchManager.getValue();
    }
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Region region, Branch branch, Department department, Business business) {
        return new BranchManagerWorkAreaJPanel(userProcessContainer,account,branch,business);
    }
