...
import Business.Region.RegionLoanIssuedComparison;
 ...
 * @author kurki
 */
public class RegionsByLoanIssuedJPanel extends javax.swing.JPanel {

   private JPanel userProcessContainer;
   private Business business;
   
    public RegionsByLoanIssuedJPanel(JPanel userProcessContainer,Business business) {
        initComponents();
     ...
     private void populateTable()
    {
        ...
        {
           Collections.sort(business.getRegionDirectory().getRegionList(),new RegionLoanIssuedComparison());
           for(Region r: business.getRegionDirectory().getRegionList())
              {
                 Object[] row = new Object[2];
                 row[0]= r.getRegionName();
                 row[1] =r.getTotalLoanIssued();
                 dtm.addRow(row);  
               }
        }
    }
    ...
    private void initComponents() {
        ...
        tblRegions.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Region Name", "Total Loan Amount Issued"
            }
        ) {
        ...
        jLabel1.setText("Regions By Issued Loan Amount");
    ...
    private void btnGraphicalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraphicalViewActionPerformed
        ...
        if(!(business.getRegionDirectory().getRegionList().isEmpty()))
        {
            for (Region r : business.getRegionDirectory().getRegionList())
            {
                dataset.setValue(r.getTotalLoanIssued(), "Total Loan Issued", r.getRegionName());
            }
        }
        JFreeChart chart = ChartFactory.createBarChart("Total Loan Issued v/s Region Graph", "Region", "Total Loan Issued", dataset,PlotOrientation.VERTICAL,false,true,false);
       
        CategoryPlot p = chart.getCategoryPlot();
        p.setRangeGridlinePaint(Color.BLUE);
     
        ChartFrame frame = new ChartFrame("Total Loan Issued v/s Region Graph",chart);
